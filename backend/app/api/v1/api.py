...
from app.api.v1.endpoints import amenities, health, journeys, incidents, washrooms, users, call_friend, osm_amenities

api_router = APIRouter()
api_router.include_router(health.router, tags=["health"])
api_router.include_router(amenities.router, prefix="/amenities", tags=["amenities"])
api_router.include_router(osm_amenities.router, prefix="/osm-amenities", tags=["osm-amenities"])
